...
echo '<div class="col-md-12" style="width:100%;"><div class="row" style="border:1px solid black;"><table class="table table-bordered table-responsive" style="border-collapse: collapse;">
	...
	';
		while($row=mysqli_fetch_assoc($verify2))
		{
			if($row['cat']==$prev2)
			{
			echo '<td>'.$row["prod"].'&nbsp;<i class="icon-trash" style="cursor:pointer;" onclick="delete2('.$row["pid"].','.$row["cid"].')"></i></td>';

			}else{
			echo '<tr style="border-top:1px solid lightgrey;text-align:center;vertical-align:middle;"><th>'.$row["cat"].'</th><td>'.$row["prod"].'&nbsp;<i class="icon-trash" style="cursor:pointer;" onclick="delete2('.$row["pid"].','.$row["cid"].')"></i></td>';
			$prev2=$row["cat"];
		}
		}
...
echo '<div class="col-md-12" style="width:100%;"><div class="row" style="border:1px solid black;"><table class="table table-bordered table-responsive" style="border-collapse: collapse;">
	...
	';
		...
		while($row=mysqli_fetch_assoc($verify2))
		{
			...
			echo '<tr><th>'.$row["cat"].'</th><td>'.$row["prod"].'&nbsp;<i class="icon-trash" style="cursor:pointer;" onclick="delete2('.$row["pid"].','.$row["cid"].')"></i></td>';
			$prev=$row["cat"];
		}
		}
...
echo '<div class="col-md-12" style="width:100%;"><div class="row" style="border:1px solid black;"><table class="table table-bordered table-responsive" style="border-collapse: collapse;">
	...
	';
		while($row=mysqli_fetch_assoc($verify2))
		{
			if($row['cat']==$prev2)
			{
			echo '<td>'.$row["prod"].'&nbsp<i class="icon-trash" style="cursor:pointer;" onclick="delete2('.$row["p_id"].','.$row["cid"].')"></i></td>';

			}else{
			echo '<tr><th>'.$row["cat"].'</th><td>'.$row["prod"].'&nbsp<i class="icon-trash" style="cursor:pointer;" onclick="delete2('.$row["p_id"].','.$row["cid"].')"></i></td>';
			$prev2=$row["cat"];
		}
		}
...
echo '<div class="col-md-12" style="width:100%;"><div class="row" style="border:1px solid black;"><table class="table table-bordered table-responsive" style="border-collapse: collapse;">
	...
	';
		...
		while($row=mysqli_fetch_assoc($verify2))
		{
			if($row['cat']==$prev)
			{
			echo '<td>'.$row["prod"].'&nbsp;<i class="icon-trash" style="cursor:pointer;" onclick="delete2('.$row["p_id"].','.$row["cid"].')"></i></td>';

			}else{
			echo '<tr><th>'.$row["cat"].'</th><td>'.$row["prod"].'&nbsp;<i class="icon-trash" onclick="delete2('.$row["p_id"].','.$row["cid"].')" style="cursor:pointer;"></i></td>';
			$prev=$row["cat"];
		}
		}
