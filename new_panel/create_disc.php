                                ...
                                <div class="form-row">
                                  <div class="col-md-4">
                                        <div class="form-group m-0">
                                            ...
                                            <input  id="disc_name" placeholder="Enter Discount name" class="form-control r-0 light s-6 " type="text" required="">
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                            <div class="form-group m-0">
                                           ...
                                           <select class="form-control" id="disc_type" required="">
                                            <option disabled="true" selected="selected">Select Category Type</option>
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input type="date" class="form-control" data-date="" data-date-format="DD MMMM YYYY" id="from_dt"  value="<?php $dat=date('Y-m-d'); echo $dat;?>" min="<?=$dat?>" onchange="to_date()" required="">
                                        </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group m-0">
                                            <label class="col-form-label s-6">Discount</label>
                                           <input  id="disc" placeholder="Enter Discount Amount" class="form-control r-0 light s-6 " type="number" required="">
                                        </div> 
                                        </div>
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input type="date" data-date="" data-date-format="DD MMMM YYYY" onchange="from_date()" id="to_dt" class="form-control" min="<?=$dat?>" required="">
                                        </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group m-0">
