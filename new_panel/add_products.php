...
<style>
  ...
  #mb th{font-size: 12px;}
  #mb1 td{font-size: 14px;}
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 880px;">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #33B5E5;">
        <h3 class="modal-title" id="exampleModalCenterTitle" style="font-size: 20px; font-weight: 600;color: #fff;"><label>ADD CATEGORY</label></h3>
    ...
    <ul>
        <li>
      <button class="btn-success" onchange="check_subcat(this.value);"><a><datalist id="cat"></datalist></a></button>
        
            <ul>
                <li>
                    <button class="btn-primary"><a><datalist id="cat"></datalist></a></button>
                    <ul>
                        <li>
                            <button class="btn-warning"><a><datalist id="sub_cats"></datalist></a></button>
                        </li>
                    </ul>
                </li>
                <li>
                   <button class="btn-primary"><a><datalist id="cat"></datalist></a></button>
                    <ul>
                        <li><button class="btn-warning"><a value="Sub Category" id="cat_sub"><datalist id="sub_cats"></datalist></a></button></li>
                        <li>
                            <button class="btn-warning"><a value="Sub Category" id="cat_sub"><datalist id="sub_cats"></datalist></a></button>
                            <ul>
                                <li>
                                    <button class="btn-info"><a value="Sub Category" id="cat_sub"><datalist id="sub_cats"></datalist></a></button>
                                </li>
                                <li>
                                    <button class="btn-info"><a>super sub category</a></button>
                                </li>
                                <li>
                                   <button class="btn-info"><a>super sub category</a></button>
                                </li>
                        ...
                        <li><button class="btn-warning"><a>sub category</a></button></li>
                    </ul>
                </li>
            </ul>
        </li>
...
<!-- new modal for add brand-->

<div class="modal fade" id="add_brand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #33B5E5;">
        <h3 class="modal-title" id="exampleModalLabel" style="font-size: 20px; font-weight: 600;color: #fff;">ADD BRAND</h3>
        <button type="button" class="close"  data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<!-- new modal for add discount-->

<div class="modal fade" id="add_disc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: ;">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #33B5E5;">
        <h3 class="modal-title" id="exampleModalLabel" style="font-size: 20px; font-weight: 600;color: #fff;">ADD DISCOUNT</h3>
        <button type="button" class="close"  data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       ...
       <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" class="form-control" id="disc">
          </div>
        </div>
      </div>
      </div>
...
<div id="myModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content" style="width: 112%;">
          <div class="modal-header" style="background-color: #33B5E5;">
        <h3 class="modal-title" style=" font-weight: 600;color: #fff;"><label>CREATE SET</label></h3>
        <button type="button" class="close"  data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
                ...
                <form action="">
                      ...
                      <div class="row"> 
                        <div class="col-2" style="margin:0;padding:0;">
                          <ul class="nav nav-tabs" id="myTab" role="tablist" style="border-bottom: 0px;">
                            <li class="nav-item">
                              <a class="nav-link active" id="v-pills-category-tab" data-toggle="tab" href="#v-pills-category" role="tab" aria-controls="v-pills-category" aria-selected="true" style="pointer-events: none;"><i class="icon icon-format_list_bulleted blue-text s-18"></i>CATEGORY</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-colour-tab" data-toggle="tab" href="#v-pills-colour" role="tab" aria-controls="v-pills-colour" aria-selected="true" style="pointer-events: none;"><i class="icon icon-palette blue-text s-18"></i>COLOUR</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-size-tab" data-toggle="tab" href="#v-pills-size" role="tab" aria-controls="v-pills-size" aria-selected="false" style="pointer-events: none;"><i class="icon icon-rupee blue-text s-18"></i>SIZE</a></li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-price-tab" data-toggle="tab" href="#v-pills-price" role="tab" aria-controls="v-pills-price" aria-selected="false" style="pointer-events: none;"><i class="icon icon-rupee blue-text s-18"></i>PRICE</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-inventory-tab" data-toggle="tab" href="#v-pills-inventory" role="tab" aria-controls="v-pills-inventory" aria-selected="false" style="pointer-events: none;"><i class="icon icon-package2 blue-text s-18"></i>INVENTORY</a>
                            </li>
                         </ul>
                        </div>
                        <div class="col-10">
                          <div class="tab-content" id="v-pills-tabContent">
                              ...
                              <div class="col-md-2">
                                      <button type="button" class="btn btn-success" onclick="nexttab('v-pills-colour')" style="margin-left: 90px;">Next</button>
                              </div>
                            </div>
                          </div>
                        </div>
                                ...
                                <!-- </div> -->
                                    <!-- </div> -->
                                  <div class="row">
                                    <div class="col-md-10" style="text-align: center;margin-left: 52px;">
                                      <h1 style="font-weight: 800;text-decoration: underline;">SELECT CATEGORY</h1>
                                      <br>
                                      <div class="row">
                                   <label id="category">
                                  <input id="cate" type="radio" name="category" value="M" onchange="show_size(this.value)" />
                                  <img src="assets/img/basic/men.png" onchange="show_size(this.value)" >
                                  <br>
                                  <h3>Mens Wear</h3>
                                </label>
                                <label id="category">
                                  <input id="cate" type="radio" name="category" value="W" onchange="show_size(this.value)" />
                                  <img src="assets/img/basic/women.png" onchange="show_size(this.value)" >
                                  <br>
                                  <h3>Womens Wear</h3>
                                </label>               
                                <label id="category">
                                  <input id="cate" type="radio" name="category" value="K" onchange="show_size(this.value)"/>
                                  <img src="assets/img/basic/kid.png" onchange="show_size(this.value)" >
                                  <br>
                                  <h3>Kids Wear</h3>
                                </label>
                              </div>
                                ...
                                <div class="row">
                                  <div class="col-md-8"></div>
                                    ...
                                    <button type="button" class="btn btn-info" onclick="nexttab('v-pills-category');">Back</button>
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn-success" onclick="info();nexttab('v-pills-size');show_temp_table('no_with_price','myTable3')">Next</button></div>
                                    ...
                                    <div id="input-outer">
                                      <input type="search" class="form-control" onkeyup="myFunction(this.value)" id="Search" placeholder="Search for color..." data-clear-btn="true">
                                              ...
                                              <?php
                                                ...
                                                ?>
                                                <br>
                                        <div id="new_color_print" style="overflow: scroll;height: 430px;">
                                                <div class="row">
                                                  <div class="col-md-12">
                                                  <label class="btn btn-success"  onclick="add_row('')"><i class="icon-plus-circle" aria-hidden="true"></i> Add Color</label>
                                                ...
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <label class="GFG target">OPTION 1&nbsp;&nbsp;</label>
                                                  </div><br>
                                                  <?php 
                                                  ...
                                                  <div class="col-md-4 target">
                                                   <div class="radio-toolbar">
                                                    ...
                                                    <label class="GFG">
                                                      <input type="radio" value="<?=$run['c_name']?>" name="clr[]" onchange="count_color_size('clr[]','min_color');disable_option('options2')" onclick="temp_clr_arr('')" class="options1" <?php $item=mysqli_query($con,"SELECT * FROM `set_details_whole` WHERE pid='$pid' and color='$c_name' and aid='$admin_id'");
                                                    // $run=mysqli_fetch_assoc($item);
                                                      ?> />&nbsp;<?php echo str_replace('_', ' ',$run['c_name']);?></label>
                                                      </div>
                                                       </div>
                                                  ...
                                                  <!-- <label id="new_color_print"></label><br>  -->
                                                        ...
                                                        <div class="col-md-3 target">
                                                          ...
                                                          <input type="checkbox" id="option2" value="<?=$run['c_name']?>" name="clr[]" onchange="disable_option('options1');count_color_size('clr[]','min_color');" onclick="temp_clr_arr('')" class="options2" <?php //$item=mysqli_query($con,"SELECT * FROM `set_details_whole` WHERE pid='$pid' and color='$c_name' and aid='$admin_id'");
                                                        // $run=mysqli_fetch_assoc($item);
                                                        ?> />&nbsp;<?php echo str_replace('_',' ',$run['c_name']);?></label>
                                                      </div>
                                                    </div>
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-info" onclick="nexttab('v-pills-size');">Back</button>
                        ...
                        <div class="col-md-2">
                          <button type="button" class="btn btn-success" onclick="info5();show_temp_table2('not_with_price','myTable4');nexttab('v-pills-inventory')">Next</button>
                  </div>
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            ...
                                            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="wsp" class="form-control" oninput="show_temp_table('with_price','myTable3')">
                                          </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-6">
                                            <label>MRP Per Pc</label>
                                            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="mrp" class="form-control" >
                                          </div>
                                  ...
                                  <div class="tab-pane" id="v-pills-inventory" role="tabpanel" aria-labelledby="v-pills-inventory-tab">
                                    <div class="row">
                                      ...
                                      <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                        <button type="button" class="btn btn-success" onclick="info4();save_data('myTable');" id="save_bt">Save</button>
                                        </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-4">
                                          ...
                                          <div class="col-md-2">
                                            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="min_set_order" class="form-control" min='1' >
                                          </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                     ...
                                     <div class="slider round"></div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-3" style="text-align: center;">
                                            <label >(IN SETS)</label>
                                            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="avail_qty_set" class="form-control" oninput="cal_qty_pcs(this.value,'avail_qty_pcs')">
                                          </div>
                                          <div class="col-md-3" style="text-align: center;">
                                            <label>(IN PCS)</label>
                                            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="avail_qty_pcs" class="form-control" oninput="cal_qty_set(this.value,'avail_qty_set')">
                                          </div>
                                          <div class="col-md-3"></div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width :880px;">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #33B5E5;">
        <h3 class="modal-title" id="exampleModalLabel" style="font-size: 20px; font-weight: 600;color: #fff;">Make Your Selection</h3>
        <button type="button" class="close"  data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>&nbsp;&nbsp;&nbsp;
        </button>
      </div>
  ...
  <div class="row">
   ...
   <div class="tree">
    <ul>
        <li>
      <button class="btn-success" onchange="check_att(this.value);"><a><datalist id="attr"></datalist></a></button>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <button class="btn-info"><a>Attributes</a></button>
                                </li>
                                <li>
                                   <button class="btn-info"><a>Attributes</a></button>
                                </li>
                        ...
                        <li><button class="btn-warning"><a>Attributes</a></button></li>
                    </ul>
                </li>
            </ul>
        </li>
  ...
  <?php }?>
     ...
     <!--new Modal for update set -->
 <div class="modal fade" id="update_set" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="width: 112%;">
      <div class="modal-header" style="background-color: #33B5E5;">
        <h3 class="modal-title" id="exampleModalLabel" style=" font-weight: 600;color: #fff; font-size: 20px;">Update Set</h3>
            ...
            <div class="col-md-10">
              <div class="row">
                     <div class="col-2" style="margin:0;padding:0;">
                          <ul class="nav nav-tabs" id="myTab" role="tablist" style="border-bottom: 0px;">
                            <li class="nav-item">
                              <a class="nav-link active" id="v-pills-category-tab_<?=$set_id?>" data-toggle="tab" href="#v-pills-category_<?=$set_id?>" role="tab" aria-controls="v-pills-category" aria-selected="true" style="pointer-events: none;"><i class="icon icon-format_list_bulleted blue-text s-18"></i>CATEGORY</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-colour-tab_<?=$set_id?>" data-toggle="tab" href="#v-pills-colour_<?=$set_id?>" role="tab" aria-controls="v-pills-colour" aria-selected="true" style="pointer-events: none;"><i class="icon icon-palette blue-text s-18"></i>COLOUR</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-size-tab_<?=$set_id?>" data-toggle="tab" href="#v-pills-size_<?=$set_id?>" role="tab" aria-controls="v-pills-size" aria-selected="false" style="pointer-events: none;"><i class="icon icon-rupee blue-text s-18"></i>SIZE</a></li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-price-tab_<?=$set_id?>" data-toggle="tab" href="#v-pills-price_<?=$set_id?>" role="tab" aria-controls="v-pills-price" aria-selected="false" style="pointer-events: none;"><i class="icon icon-rupee blue-text s-18"></i>PRICE</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="v-pills-inventory-tab_<?=$set_id?>" data-toggle="tab" href="#v-pills-inventory_<?=$set_id?>" role="tab" aria-controls="v-pills-inventory" aria-selected="false" style="pointer-events: none;"><i class="icon icon-package2 blue-text s-18"></i>INVENTORY</a>
                            </li>
                         </ul>
                        </div> 
               
                <div class="col-10">
                  <div class="tab-content" id="v-pills-tabContent" style="margin-left: 42px;">
                        <div class="tab-pane active" id="v-pills-category_<?=$set_id?>" role="tabpanel" aria-labelledby="v-pills-category-tab_<?=$set_id?>">
                          <!-- <div class="row"> -->
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                <button type="button" class="btn btn-success" onclick="nexttab2('v-pills-colour_<?=$set_id?>');color_tab('<?=$set_id?>','<?=$row3['min_color']?>');show_size2(document.getElementById('cate_<?=$set_id?>').value,'<?=$set_id?>','<?=$row4['min_size']?>');">Next</button>
                              </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <button type="button" class="btn btn-success" onclick="info();nexttab2('v-pills-size_<?=$set_id?>');show_size2(document.getElementById('cate_<?=$set_id?>').value,'<?=$set_id?>','<?=$row4['min_size']?>');">Next</button>
                                    </div>
...
<!-- new modal update set-->
     <div class="modal fade" id="s_<?=$set_id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="width: 112%;">
      <div class="modal-header" style="background-color: #33B5E5;">
        <h5 class="modal-title" id="exampleModalLabel" style=" font-weight: 600;color: #fff; font-size: 20px;">Update Set</h5>
        <button type="button" class="close" onclick="reset_val('close_<?=$set_id?>')" id="close_<?=$set_id?>" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <div class="row" style="margin-top: -15px;"> 
                          ...
                          <!-- <div class="row"> -->
                            <div class="row">
                              <div class="col-md-12">
                                <div class="row">
                              <div class="col-md-2">
                              <button type="button" class="btn btn-success" onclick="nexttab2('v-pills-colour_<?=$set_id?>');color_tab('<?=$set_id?>','<?=$rows['min_color']?>');show_size2(document.getElementById('cate_<?=$set_id?>').value,'<?=$set_id?>','<?=$rows['min_size']?>');">Next</button>
                              </div>
                              <div class="col-md-10"></div>
                            </div>
                          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <label>Wholesale Price Per Pc</label>
                <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="wsp_<?=$set_id?>" class="form-control" value="" oninput="show_temp_table3('with_price_w','myTable3_<?=$set_id?>');">
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <label>MRP Per Pc</label>
                <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="mrp_<?=$set_id?>" class="form-control" >
              </div>
             <!-  <div class="col-md-3" style="margin-top: 20px;">
                <button type="button" class="btn btn-success" onclick="save_data('myTable3')">View Set Table</button>
              </div> ->
...
<button type="button" class="btn btn-info" onclick="nexttab2('v-pills-price_<?=$set_id?>');">Back</button>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="min_set_order_<?=$set_id?>" class="form-control" min='1' >
              </div>
            </div>
            <br>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3" style="text-align: center;">
                <label >(IN SETS)</label>
                <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="avail_qty_set_<?=$set_id?>" class="form-control">
              </div>
              <div class="col-md-3" style="text-align: center;">
                <label>(IN PCS)</label>
                <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="avail_qty_pcs_<?=$set_id?>" class="form-control">
              </div>
              <div class="col-md-3"></div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header" style="width: 68%;">
              ...
              <div class="card-body">
                 <div class="phone view_3" id="phone_1">
                  ...
                  <h3 class="card-title" style="float: none;text-align: center;font-weight:800;">Mobile View</h3>
                </div>
                        <div id="myTable">
                        <?php 
                        // $s_id=$row['set_id'];
                       $query1=mysqli_query($con,"SELECT * FROM `set_details_whole` WHERE s_id='$s_id' and pid='$pid' and aid='$admin_id' group by set_id");
                        ...
                        <table class="table table-bordered" style="border:1px solid black;">
                          ...
                          $sno++;
                               ?>
                               <tr id="mb1" <?php if($prev==$row2['size']){}else{ ?> style="border-top: 2px solid black;"<?php }?> >
                            <td><?php echo $sno;?></td>
              ...
              event.keyCode === 46 ? true : !isNaN(Number(event.key))" id="sum_qty1" value="<?=$qty?>" step="<?=$qty?>" min="0"/ name="set_qty[]" onchange="sum()" onkeydown="return false" > -->
                ...
                ?></tr>
                        ...
                        <div class="col-md-2" style="float: left;">
                            <i class="icon-edit" style="cursor: pointer;" data-toggle="modal" data-target="#update_set" ></i>&nbsp;&nbsp;
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" class="form-control" value="<?=$rows['min_color']?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Min Size To Choose</label>
                                        <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" class="form-control" value="<?=$rows['min_size']?>">
                                    </div>
                                </div>
                            </div>
                        </div><br>
              ...
              <i class="icon-edit" style="cursor: pointer;" data-toggle="modal" data-target="#update_set"></i>&nbsp;&nbsp;
                ...
                <form role="form" action="add_product.php" method="POST" enctype="multipart/form-data">
                  <div class="row" style="margin-left: 10px;">
                    ...
                    <i class="icon-trash" style="cursor: pointer;" onclick="delete_img('<?=$r_img['img_url']?>')"></i>
                  <?php }?>
                  </div>
                  <div class="row">
                ...
                <div class="row">
                 ...
                 <div class="col-sm-5"  style="margin-left: 10px;">
                      <div class="form-group">
                        ...
                        <input type="text" id="new_id" value="<?=$row['item_name']?>" class="form-control" onfocusout="fill_title(this.value)">
                    ...
                    <div class="col-sm-5">
                      <div class="form-group">
                        ...
                        <input type="text" id="title" value="<?=$row['title']?>" class="form-control" onfocusout="fill_title2(this.value)">
                    ...
                    <div class="col-sm-5" style="margin-left: 10px;">
                      <div class="form-group">
                       <!--  <label>Wholesale Price</label>
                        <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))" class="form-control" id="price" placeholder="Enter ..."> -->
                ...
                <div class="card-body" id="details" style="background-color: #f5f5f5;">
                <label>Colors: </label>
                <span style="font-size: 20px; font-weight: 300;"><?php  
                    $set_id=$rows['set_id'];
                    $query5=mysqli_query($con,"SELECT DISTINCT(color) FROM `set_details_whole` WHERE set_id='$set_id' and s_id='$s_id' and aid='$admin_id'");
                    $sno='';
                    while($row5=mysqli_fetch_assoc($query5))
                ...
                <br>
               <span style="font-size: 20px; font-weight: 300;">Set of : <?php echo $sum_q.'(in pcs)';?></span>
               <br>
                <span style="font-size: 20px; font-weight: 300;"><?php echo $sum_q.'(in pcs) in rs- '. ($wsp).'.00/-';?></span>
                <br>
                 
                <section id="how-to" style="margin-top: 16px;">
        <!-- Super Accordion -->
      <div class="panel-group" id="superaccordion">
        <!-- Accordion 1 -->
        <div class="panel">
          <div class="panel-heading parent">
            <a class="accordion-toggle" id="btn_panel" data-toggle="collapse" data-parent="#superaccordion" href="#collapse1" aria-expanded="false" onclick="panelHeading()">View Details</a>
          </div>
                    ...
                    <div id="myTable">
                       ...
                       $query1=mysqli_query($con,"SELECT * FROM `set_details_whole` WHERE s_id='$s_id' and pid='$pid' and aid='$admin_id' group by set_id");
                        ...
                        <table class="table table-bordered" style="border:1px solid black;">
                          ...
                          $sno++;
                               ?>
                               <tr <?php if($prev==$row2['size']){}else{ ?> style="border-top: 2px solid #e1e8ee;"<?php }?> >
                            <td><?php echo $sno;?></td>
                            <td><?php echo str_replace('_', ' ',$row2['color']);?></td>
                            <td><?php echo $row2['size'];
              ...
              <i class="icon-edit" style="cursor: pointer;" data-toggle="modal" data-target="#update_set"></i>&nbsp;&nbsp;
                <i class="icon-trash" style="cursor: pointer;" onclick="delete_set('<?=$set_id?>');"></i>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="col-sm-5">
                        <label class="btn btn-primary" data-toggle="modal" data-target="#add_disc" id="discount_btn" style="margin-bottom: 13px;">Add Discount&nbsp;&nbsp;<i class="icon-plus-circle" aria-hidden="true"></i></label>
                      </div>
                       <!-- <div class="col-sm-5" style="margin-left: 10px;">
                ...
                <div class="row">
                    <div class="col-sm-12">
                      <div class="col-sm-5">
                        <label class="btn btn-primary" data-toggle="modal" data-target="#add_cat" id="cat_btn" data-backdrop="static" data-keyboard="false">Add Category&nbsp;&nbsp;<i class="icon-plus-circle" aria-hidden="true"></i></label>
                      </div>
                       <!-- <div class="col-sm-5">
                ...
                <div class="row">
                    <div class="col-sm-5" style="margin-left: 10px;">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="category" onchange="show_subcat(this.value)" style="width: 100%;">
                    ...
                    <!-- <div class="col-sm-6"> -->
                      <!-- <div class="col-sm-5">
                       ...
                       <div class="col-sm-5" style="margin-left: 15px;">
                        <label class="btn btn-primary" data-toggle="modal" data-target="#add_brand" id="brand_btn" data-backdrop="static" data-keyboard="false" style="margin-bottom: 13px;">Add Brand&nbsp;&nbsp;<i class="icon-plus-circle" aria-hidden="true"></i></label>
                      </div>
                    <!-- </div> -->
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-5" style="margin-left: 10px;">
                      <div class="form-group">
                        <label class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="Attributes">Attributes&nbsp;&nbsp;<i class="icon-plus-circle" aria-hidden="true"></i></label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
if (r == true) {
    $.ajax({
        ...
        success:function(res) {
            if(res==1)
            {
                window.location.href="add_products.php?pid=<?=$pid?>";
            }else{
                alert(res);
            }
        }
