  ...
  <body>
    ...
    <div class="suha-sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        ...
        <div class="user-info">
          <h6 class="user-name mb-0">Supplier Name</h6>
         <h6 class="user-name mb-0">Firm Name</h6>
        </div>
      </div>
      <!-- Sidenav Nav-->
      ...
      <!--   <li><a href="notifications.php"><i class="lni lni-alarm lni-tada-effect"></i>Notifications<span class="ms-3 badge badge-warning">3</span></a></li> -->
       <!--  <li class="suha-dropdown-menu"><a href="#"><i class="lni lni-cart"></i>Shop Pages</a>
        ...
        <li><a href="feedback.php"><i class="lni lni-comments"></i>Feedback Us</a></li>
         <li><a class="btn btn-warning" href="intro.php"><i class="lni lni-power-switch"></i>Sign Out</a></li>
