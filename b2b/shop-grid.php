      ...
      <div class="top-products-area py-3">
        <div class="container">
          ...
          <div class="product-catagories">
            <div class="row g-3">
              <!-- Single Catagory-->
              <div class="col-4"><a class="shadow-sm" href="#"><img src="img/product/5.png" alt="">category1</a></div>
              <!-- Single Catagory-->
              <div class="col-4"><a class="shadow-sm" href="#"><img src="img/product/9.png" alt="">category2</a></div>
              <!-- Single Catagory-->
              <div class="col-4"><a class="shadow-sm" href="#"><img src="img/product/4.png" alt="">category3</a></div>
            </div>
          </div>
          <div class="row g-3">
