            ...
            <div class="register-form mt-5 px-4">
              <form action="otp.php" method="">
                ...
                <div class="form-group text-start mb-4"><span>Password</span>
                  ...
                  <input class="input-psswd form-control" id="registerPassword" type="password" placeholder="Enter Password">
                </div>
                <button class="btn btn-lg w-100" type="submit" style="background-color: #fff;">Sign Up</button>
              </form>
            </div>
            <!-- Login Meta-->
