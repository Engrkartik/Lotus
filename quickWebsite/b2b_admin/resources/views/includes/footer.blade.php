...
<script type="text/javascript">
    ...
    //                     onclick="javascript:$('.${className}').select2('close');">dd</a>`;
...
//<![CDATA[
  ...
  //]]>
   ...
   // Initialize select2
//    $("#att_type").select2();
   $("#att_type").select2({ placeholder: "Select Type", });  
   $("#att_subtype").select2({ placeholder: "Select Sub Type", });  
   $("#category").select2({ placeholder: "Select Category", });  
   $("#subcategory").select2({ placeholder: "Select Sub Category", });  
   $(".attribute").select2({ placeholder: "Select Attribute", });  
   $(".multi-select").select2({ placeholder: "Select Option",width:'resolve' });  
