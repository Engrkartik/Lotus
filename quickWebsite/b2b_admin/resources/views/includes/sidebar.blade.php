 ...
 <nav class="sidebar">
     ...
     <ul id="sidebar_menu">
        ...
        <li>
         ...
         <li>
             <a href="{{url('banner')}}" aria-expanded="false">
                 <div class="nav_icon_small" >
                     <i class="fas fa-clone" style="margin-right:0px;"></i>
                 </div>
                 <div class="nav_title">
                     <span>Banner</span>
                 </div>
         ...
         <li>
            <a href="{{url('brand')}}" aria-expanded="false">
                <div class="nav_icon_small" >
                    <i class="fas fa-bookmark" style="margin-right:0px;"></i>
                </div>
                <div class="nav_title">
                    <span>Brand</span>
                </div>
        ...
        <li>
            <a href="{{url('discount')}}" aria-expanded="false">
                <div class="nav_icon_small" >
                    <i class="fas fa-percent" style="margin-right:0px;"></i>
                </div>
                <div class="nav_title">
                    <span>Discount</span>
                </div>
        ...
        <li>
            <a href="{{url('attributes')}}" aria-expanded="false">
                <div class="nav_icon_small" >
                    <i class="fas fa-cubes" style="margin-right:0px;"></i>
                </div>
                <div class="nav_title">
         ...
         <h4 class="menu-text"><span>Customer</span></h4>
         <li>
            <a href="{{url('customer')}}" aria-expanded="false">
                <div class="nav_icon_small" >
                    <i class="fas fa-user" style="margin-right:0px;"></i>
                </div>
                <div class="nav_title">
                    <span>Customer</span>
                </div>
