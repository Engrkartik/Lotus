...
Application or make payments, including any in-game virtual items, which may also collect and
use data about you. We are not responsible for any of the data collected by any such third party.
...
<h2>Personal Data</h2>
Personally identifiable information (such as your name that you voluntarily give to us when
choosing to participate in various activities related to the Application, such as chat, posting
messages in comment sections or in our forums, liking posts, sending feedback, and responding
to surveys. If you choose to share data about yourself via your profile, online chat, or other
interactive areas of the Application, please be advised that all data you disclose in these areas is
private and your data will be accessible to us.
...
mobile device’s [Bluetooth, calendar, camera, contacts, microphone, reminders, sensors, SMS
messages, social media accounts, storage,] and other features. If you wish to change our access
...
provide.
<h2>Location</h2>
The company wants to track the actual distance traveled by the user for taking the order.
<h2>Call Logs</h2>
The user is using the company's property(device and SIM) and so we want to track the total number of 
calls made to our respective customers during the day for our managing purpose.
...
5. Deliver targeted advertising, coupons, newsletters, and other information regarding
...
Application.
9. Generate a personal profile about you to make future visits to the Application more
personalized.
...
contained in web cookies in order to provide advertisements about goods and services of interest
to you. 
<h2>Affiliates</h2>
...
acknowledge that such transfers may occur and that the transferee may decline honor
...
data, and we have no authority to manage or control third-party solicitations. If you no longer
wish to receive correspondence, emails or other communications from third parties, you are
...
Application, your personal information is not collected through the use of tracking technology.
Most browsers are set to accept cookies by default. You can remove or reject cookies, but be
aware that such action could affect the availability and functionality of the Application. You may
not decline web beacons. However, they can be rendered ineffective by declining all cookies or
by modifying your web browser’s settings to notify you each time a cookie is tendered, permitting
...
experience with us. For more information about opting-out of interest-based ads.
...
links to leave the Application, any information you provide to these third parties is not covered by
...
the privacy policies and practices (if any) of the third party responsible for that website, and should
take those steps necessary to, in your discretion, protect the privacy of your information. We are
...
by unauthorized parties. Therefore, we cannot guarantee complete security if you provide
...
<h3>SSS SYBER TECH PRIVATE LIMITED</h3>
Office number- 914, 9th floor, tower-A, i-thum
Noida, Sector-62, Uttar Pradesh - 201301
7290042960
[info@ssssybertech.com]
</body>
</html>