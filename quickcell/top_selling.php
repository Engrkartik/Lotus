          ...
          <div class="col-12">
            <div class="card card-warning">
                <h3 class="card-title">
                  ...
                  <a href="add_top_selling.php"><button class="btn btn-dark" style="width: 10%">Add</button></a>
                ...
                <table class="table table-hover text-nowrap" id="myTable">
                  <thead>
                    <tr>
                      ...
                      <?php 
                          $fetch_cust = mysqli_query($con,"SELECT product_order.*, product.item_name FROM `product_order` left JOIN product on product_order.pid = product.id WHERE product_order.top != 0 and product_order.status='A' and product.aid='$admin_id' ORDER BY product_order.top asc");
                    ...
                    <tbody>
                      <tr>
                        <td><?php echo $sn;?></td>
                        <td><?=$row['item_name']?></td>
                        <td><a class="fa fa-edit" style="color: green" aria-hidden="true" href="edit_top.php"></a> &nbsp; <a class="fa fa-trash" style="color: green" aria-hidden="true" onclick="product_del('<?=$row["id"]?>','<?=$row["pid"]?>')"></a></td>
                      </tr>
                    </tbody>
                      <?php } ?>
                  </table>
