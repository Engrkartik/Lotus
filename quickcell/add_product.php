    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <?php
                ...
                <div class="col-md-4 target">
                  <label class="GFG"><input type="radio" value="<?=$run['c_name']?>" name="clr[]" class="option1"/>&nbsp;<?php echo str_replace('_', ' ',$run['c_name']);?></label></div>
            ...
            <?php }
                ...
                <div class="col-md-4 target">
                  <label class="GFG"><input type="checkbox" class="my_categories" id="option2" value="<?=$run['c_name']?>" name="clr[]" onchange="disable_option('option1')" class="option2" />&nbsp;<?php echo str_replace('_', ' ',$run['c_name']);?></label></div>
                		...
                		<div class="">
                			...
                			$type=$run['type'];
                			 ...
                			 while ($run2=mysqli_fetch_assoc($s_size)) {
                			 	?>
                			 <label class="GFG">	<input class="my_categories" type="checkbox" value="<?=$run2['size_name']?>" name="size[]"/>&nbsp;&nbsp;<?php echo $run2['size_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                			 <?php }
                			?>
                		</div>
                	</div>
