            ...
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title">
                  ...
                  {
                  ?>
                  <a href="cust_detail.php"><button class="btn btn-primary">Add Customer</button></a></h3>
                <?php }?>
              ...
              <div class="card-body">
                  ...
                  <thead>
                    <tr>
                     <th>S.NO</th>
                                        <th>FIRM NAME</th>
                                        <th>OWNER NAME</th>
                                        <th <?php if($f_chk['business_type']=='R'){?>style="display: none;"<?php }?>>BUSINESS TYPE</th>
                ...
                <td <?php if($f_chk['business_type']=='R'){?>style="display: none;"<?php }?>><?php if($row['BUSINESS']=='W'){echo "Wholesale";}else{echo "Retailer";};?></td>
