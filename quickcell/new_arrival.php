                ...
                <table class="table table-hover text-nowrap" id="myTable">
                  <thead>
                    <tr>
                      ...
                      <?php 
                          $fetch_cust = mysqli_query($con,"SELECT product_order.*, product.item_name FROM `product_order` left JOIN product on product_order.pid = product.id WHERE product_order.new != 0 and product_order.status = 'A' and product.aid='$admin_id' ORDER BY product_order.new asc");
