                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="mob_no" onKeyPress="if(this.value.length==10) return false;" placeholder="Enter ..." required="" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
