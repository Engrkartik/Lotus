...
//Get the temp file path
  ...
  if ($tmpFilePath != ""){
    ...
    $IDproofImage = $cid."_".uniqid();
    $newFilePath = "../images/issues/" .$IDproofImage."_".$_FILES['files']['name'][$i];

    //Upload the file into the temp dir
    if(move_uploaded_file($tmpFilePath, $newFilePath)) {

      //Handle other code here
    $img_insert=mysqli_query($con,"INSERT INTO `issue_img`(`aid`, `cid`, `img_id`, `img_url`, `date`) VALUES ('$admin_id','$cid','$img_id','$newFilePath','$dj')");
...
if($query)
{
    ...
    // // echo $email;
        ...
        $mail->AddAttachment($newFilePath,$_FILES['files']['name']);
