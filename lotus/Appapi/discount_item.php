...
if(($cat_id!="") and ($discount!=""))
{
  ...
  $dis="product.id IN (SELECT pid FROM discount where aid='$admin_id' and discount.from_dt<='$today' and discount.to_dt>='$today') and ";
...
{ $data=null;
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and product.sale_price<='$price_max' GROUP BY product.id $orderby");
  while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
{ $data=null;
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and (product.sale_price>='$price_min' and product.sale_price<='$price_max') GROUP BY product.id $orderby");
  while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach ($brand_arr as $value) {
  $brand=$value->brand;
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and product.brand='$brand' GROUP BY product.id $orderby");
  while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach($brand_arr as $value) {
  ...
  $size=$value2->size;
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and (product.sale_price>='$price_min' and product.sale_price<='$price_max') and (product.brand='$brand') and set_details.size='$size' GROUP BY product.id $orderby");
   while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach($brand_arr as $value) {
 ...
 foreach ($color_arr as $value3) {
  ...
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' and product.brand='$brand' $cat AND product.avail_qty>0 and (product.sale_price>='$price_min' and product.sale_price<='$price_max') and set_details.size='$size' and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' GROUP BY product.id $orderby");
   while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach($brand_arr as $value) {
  ...
  $size=$value2->size;
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  (product.brand='$brand') and set_details.size='$size' GROUP BY product.id $orderby");
   while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach($brand_arr as $value) {
 ...
 foreach ($color_arr as $value3) {
  ...
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  (product.brand='$brand') and set_details.size='$size' and set_details.color='$color' GROUP BY product.id $orderby");
...
foreach($brand_arr as $value) {
 ...
 foreach ($color_arr as $value3) {
  ...
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' and product.brand='$brand' $cat AND product.avail_qty>0 and  set_details.size='$size' and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' GROUP BY product.id $orderby");
   while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach($brand_arr as $value) {
 ...
 foreach ($color_arr as $value3) {
  ...
  $pattern=str_replace(' ','_',$value5->Sub_att);
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' and product.brand='$brand' and set_details.color='$color' and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' GROUP BY product.id $orderby");
   while ($run1=mysqli_fetch_assoc($query1)) {
  ...
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' and product.brand='$brand' and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' GROUP BY product.id $orderby");
   while ($run=mysqli_fetch_assoc($query)) {
   $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
$img = [];
...
foreach($brand_arr as $value) {
 ...
 foreach ($color_arr as $value3) {
  ...
  foreach ($ocassion_arr as $value6) {
    $ocassion=str_replace(' ','_',$value6->Sub_att);
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' and product.brand='$brand' and set_details.color='$color' and prod_attribute.sub_cat='OCCASION' and prod_attribute.attribute='$ocassion' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query1))
{
  $pid=$run3['id'];
  foreach($pattern_arr as $value5) {
  ...
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' and product.brand='$brand' and set_details.color='$color' and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' and product.id='$pid' GROUP BY product.id $orderby");
   while ($run2=mysqli_fetch_assoc($query)) {
 $pid=$run2['id'];
 foreach($fabric_arr as $value4)
 {
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query2=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' and product.brand='$brand' and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' and product.id='$pid' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query2))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
//  $brand=$value->brand;
  ...
  $size=$value2->size;
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query1))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
foreach ($color_arr as $value3) {
  ...
  $size=$value2->size;
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size' and set_details.color='$color' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query1))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
while($run1=mysqli_fetch_assoc($query1))
{
 ...
 {
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size'  and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' and product.id='$pid' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
while($run1=mysqli_fetch_assoc($query1))
{
  ...
  $query2=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size'  and set_details.color='$color' and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' and product.id='$pid' GROUP BY product.id $orderby");
   while ($run2=mysqli_fetch_assoc($query2)) {
 $pid=$run2['id'];
 foreach($fabric_arr as $value4)
 {
...
while($run3=mysqli_fetch_assoc($query3))
{
  ...
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size'  and set_details.color='$color' and prod_attribute.sub_cat='OCCASION' and prod_attribute.attribute='$ocassion' and product.id='$pid' GROUP BY product.id $orderby");
while($run1=mysqli_fetch_assoc($query1))
{
  $pid=$run1['id'];
  foreach($pattern_arr as $value5) {
...
// {
   foreach($sleeve_arr as $value7)
  {
    $sleeve=str_replace(' ','_',$value7->Sub_att);
     ...
     $query3=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size'  and set_details.color='$color' and prod_attribute.sub_cat='SLEEVES' and prod_attribute.attribute='$sleeve' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query3))
{
   foreach ($ocassion_arr as $value6) {
   $pid=$run3['id'];
 ...
 foreach($type_arr as $value8)
  {
    $type=str_replace(' ','_',$value8->Sub_att);
     ...
     $query4=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size'  and set_details.color='$color' and prod_attribute.sub_cat='TYPE' and prod_attribute.attribute='$type' GROUP BY product.id $orderby");
while($run4=mysqli_fetch_assoc($query4))
{
  $pid=$run4['id'];
   foreach($sleeve_arr as $value7)
  {
    $sleeve=str_replace(' ','_',$value7->Sub_att);
     ...
     $query3=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0 and  set_details.size='$size'  and set_details.color='$color' and prod_attribute.sub_cat='SLEEVES' and prod_attribute.attribute='$sleeve' and product.id='$pid' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query3))
{
   foreach ($ocassion_arr as $value6) {
   $pid=$run3['id'];
...
foreach ($color_arr as $value3) {
  ...
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and set_details.color='$color' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query1))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
foreach ($color_arr as $value3) {
 ...
 {
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
foreach ($color_arr as $value3) {
  ...
  $query2=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' GROUP BY product.id $orderby");
   while ($run2=mysqli_fetch_assoc($query2)) {
 $pid=$run2['id'];
 foreach($fabric_arr as $value4)
 {
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' and product.id='$pid' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
foreach ($color_arr as $value3) {
  ...
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='OCCASION' and prod_attribute.attribute='$ocassion' GROUP BY product.id $orderby");
while($run1=mysqli_fetch_assoc($query1))
{
  $pid=$run1['id'];
  foreach($pattern_arr as $value5) {
  ...
  $query2=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' and product.id='$pid' GROUP BY product.id $orderby");
   while ($run2=mysqli_fetch_assoc($query2)) {
 $pid=$run2['id'];
 foreach($fabric_arr as $value4)
 {
...
foreach ($color_arr as $value3) {
   ...
   foreach($sleeve_arr as $value7)
  {
    $sleeve=str_replace(' ','_',$value7->Sub_att);
     ...
     $query3=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='SLEEVES' and prod_attribute.attribute='$sleeve' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query3))
{
   foreach ($ocassion_arr as $value6) {
   $pid=$run3['id'];
  ...
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='OCCASION' and prod_attribute.attribute='$ocassion' and product.id='$pid' GROUP BY product.id $orderby");
while($run1=mysqli_fetch_assoc($query1))
{
  $pid=$run1['id'];
  foreach($pattern_arr as $value5) {
 ...
 foreach($type_arr as $value8)
  {
    $type=str_replace(' ','_',$value8->Sub_att);
     ...
     $query4=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='TYPE' and prod_attribute.attribute='$type' GROUP BY product.id $orderby");
while($run4=mysqli_fetch_assoc($query4))
{
  $pid=$run4['id'];
   foreach($sleeve_arr as $value7)
  {
    $sleeve=str_replace(' ','_',$value7->Sub_att);
     ...
     $query3=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0   and set_details.color='$color' and prod_attribute.sub_cat='SLEEVES' and prod_attribute.attribute='$sleeve' and product.id='$pid' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query3))
{
   foreach ($ocassion_arr as $value6) {
   $pid=$run3['id'];
...
$fabric_arr=json_decode($fabric);
 ...
 {
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
$pattern_arr=json_decode($pattern);
  ...
  $query2=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' GROUP BY product.id $orderby");
   while ($run2=mysqli_fetch_assoc($query2)) {
 $pid=$run2['id'];
 foreach($fabric_arr as $value4)
 {
  $fabric=str_replace(' ','_',$value4->Sub_att);
  $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='FABRIC' and prod_attribute.attribute='$fabric' and product.id='$pid' GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
...
$ocassion_arr=json_decode($ocassion);
  ...
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='OCCASION' and prod_attribute.attribute='$ocassion' GROUP BY product.id $orderby");
while($run1=mysqli_fetch_assoc($query1))
{
  $pid=$run1['id'];
  foreach($pattern_arr as $value5) {
  ...
  $query2=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='PATTERN' and prod_attribute.attribute='$pattern' and product.id='$pid' GROUP BY product.id $orderby");
   while ($run2=mysqli_fetch_assoc($query2)) {
 $pid=$run2['id'];
 foreach($fabric_arr as $value4)
 {
...
$sleeve_arr=json_decode($sleeve);
   ...
   foreach($sleeve_arr as $value7)
  {
    $sleeve=str_replace(' ','_',$value7->Sub_att);
     ...
     $query3=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='SLEEVES' and prod_attribute.attribute='$sleeve' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query3))
{
   foreach ($ocassion_arr as $value6) {
   $pid=$run3['id'];
  ...
  $query1=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='OCCASION' and prod_attribute.attribute='$ocassion' and product.id='$pid' GROUP BY product.id $orderby");
while($run1=mysqli_fetch_assoc($query1))
{
  $pid=$run1['id'];
  foreach($pattern_arr as $value5) {
 ...
 foreach($type_arr as $value8)
  {
    $type=str_replace(' ','_',$value8->Sub_att);
     ...
     $query4=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='TYPE' and prod_attribute.attribute='$type' GROUP BY product.id $orderby");
while($run4=mysqli_fetch_assoc($query4))
{
  $pid=$run4['id'];
   foreach($sleeve_arr as $value7)
  {
    $sleeve=str_replace(' ','_',$value7->Sub_att);
     ...
     $query3=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  and prod_attribute.sub_cat='SLEEVES' and prod_attribute.attribute='$sleeve' and product.id='$pid' GROUP BY product.id $orderby");
while($run3=mysqli_fetch_assoc($query3))
{
   foreach ($ocassion_arr as $value6) {
   $pid=$run3['id'];
...
else
{
  $data=null;
     ...
     $query=mysqli_query($con,"SELECT product.*,(SELECT disc FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc,(SELECT disc_type FROM discount where aid='$admin_id' and pid=product.id and discount.from_dt<='$today' and discount.to_dt>='$today') as disc_type,prod_img.img_url,category.title as cat_title  FROM `product` LEFT JOIN category ON category.id=product.cat_id LEFT JOIN prod_img on prod_img.img_id=product.img LEFT JOIN set_details ON set_details.set_id=product.set_id LEFT JOIN prod_attribute ON prod_attribute.att_id=product.att_id WHERE $dis product.aid='$admin_id' and product.status='A' $cat AND product.avail_qty>0  GROUP BY product.id $orderby");
while($run=mysqli_fetch_assoc($query))
{
  $img_id=$run['img'];
$img_query=mysqli_query($con,"SELECT img_url FROM `prod_img` WHERE `img_id` = '$img_id'");
