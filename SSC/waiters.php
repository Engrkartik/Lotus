...
include 'includes/header.php';
  ...
  <!-- START MAIN -->
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Waiter's</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <form class="formValidate" id="formValidate1" method="post" action="routers/add-waiter.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header btn btn-primary" onclick="show_add_item()">Add Waiter</h4>
              </div>
              ...
              <table class="table table-bordered" >
                    <thead>
                      <tr>
                        ...
                        <th data-field="waiter_id" style="text-align: center;">Waiter Id</th>
          ...
          <td><div class="input-field col s12"><label for="waiter_id">Waiter Id</label>
          <input id="waiter_id" name="waiter_id" type="text" data-error=".errorTxt04"><div class="errorTxt04"></div></td>
          ...
          <input id="password" name="password" type="text" data-error=".errorTxt05"><div class="errorTxt05"></div></td>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Waiter's List</h4>
              </div>
              <div>
				  <table id="data-table-admin" class="table display table-bordered" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <th  style="vertical-align: middle;text-align: center;">Waiter Id</th>
                    ...
                    <tbody>
            				<?php
            				$result = mysqli_query($con, "SELECT users.*,branch.name as b_name FROM `users` LEFT JOIN branch on branch.id=users.branch where users.status!='R' and users.role='Waiter'");
                      ...
                      <td><i class="fa fa-trash" style="cursor:pointer;" onclick="del('.$row['id'].',\'waiters\')"></i></td></tr>';
